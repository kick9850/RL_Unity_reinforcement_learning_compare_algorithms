...
class DQNAgent:
    def __init__(self,
        ...
        self.explore_step = explore_step * step
        self.epsilon = epsilon_init if train_mode else epsilon_eval
        self.batch_size = batch_size
        self.discount_factor = discount_factor
        self.epsilon_delta = (epsilon_init - self.epsilon_min) / self.explore_step if train_mode else 0.
    ...
    def train_model(self):
        ...
        loss.backward()
        self.optimizer.step()
        self.epsilon = max(self.epsilon_min, self.epsilon - self.epsilon_delta)  # 수정된 부분
        return loss.item()
